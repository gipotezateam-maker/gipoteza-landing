      ...
      <div className="container">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "2.5rem" }} className="lg:grid-cols-[1fr_300px] lg:gap-12">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.35, ease: [0.16, 1, 0.3, 1] }}
            ...
            {/* Логотипы клиентов */}
            <div style={{ display: "flex", flexWrap: "wrap", gap: "2.5rem", alignItems: "center", marginTop: "1.5rem" }}>
              {[
                ...
                <div key={logo.alt} style={{ width: "140px", height: "56px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <img
                    src={logo.src}
                    alt={logo.alt}
                    style={{ maxWidth: "140px", maxHeight: "56px", width: "auto", height: "auto", objectFit: "contain", opacity: 0.85 }}
                  />
                </div>
              ))}
            </div>
...
function WebinarExamples() {
  ...
  const videos = [
    {
      id: "v1",
      title: "День открытых дверей в Онлайн-школе №1",
      client: "Онлайн-школа",
      tag: "Живой вебинар",
      embed: "https://rutube.ru/play/embed/8ec01debb50c163baa6bc5c5b609bae9/?p=453QWTDVPy3yIcnaIzP2bg",
      thumb: "https://pic.rtbcdn.ru/video/2025-07-18/f0/e9/f0e90e657c49b51636870a0689289cfe.jpg",
    },
    {
      id: "v2",
      title: "Онлайн-марафон «3 профессии за 3 дня»",
      client: "EdTech проект",
      tag: "Автовебинар",
      embed: "https://rutube.ru/play/embed/ab6d8b0b50f8d33fd3eadc6b70faf7bb/?p=7YhvH5tTfMKP7yBJjyvH0Q",
      thumb: "https://pic.rtbcdn.ru/video/2026-01-27/8f/cd/8fcd04faf3504eb9323a6e5550022d8f.jpg",
    },
    {
      id: "v3",
      title: "Будущее без ЕГЭ: реальный опыт",
      client: "Онлайн-курс",
      tag: "Живой вебинар",
      embed: "https://rutube.ru/play/embed/e53552d8fa63f40530091a5145db7a9d/?p=xbJfFXvw6z21LvNGlgMDHw",
      thumb: "https://pic.rtbcdn.ru/video/2026-02-27/01/4e/014e18d1497751fdcc4441bd6e7e2eb8.jpg",
    },
    {
      id: "v4",
      title: "Как питаться, когда нет времени на идеальный рацион",
      client: "EdTech бренд",
      tag: "Запуск",
      embed: "https://rutube.ru/play/embed/901e20ed311e244fe1325f881055742f/?p=Akw1rFs7nDN3jefEUVDQ0g",
      thumb: "https://pic.rtbcdn.ru/video/2026-02-27/68/8c/688c6aa5eb61328de3043c1dc53369f2.jpg",
    },
    {
      id: "v5",
      title: "Профориентация: как готовить ребёнка к успешному будущему",
      client: "Онлайн-школа",
      tag: "Автовебинар",
