...
const SCENES: Scene[] = [
  {
    ...
    situation: "Запускаешь вебинар по онлайн-курсу «Профессия SMM-специалист» для физлиц. Лендинг готов, трафик идёт из Яндекс.Директ. CR в регистрацию: 3.2%. Средний CR по рынку B2C EdTech — 18–26%. Бюджет на трафик: 180К ₽. CAC текущий: 4 800 ₽. Целевой CAC: 750 ₽. Вебинар через 10 дней. Средний чек курса: 39 900 ₽.",
    metrics: "CR: 3.2% | CAC: 4 800 ₽ | Бюджет: 180К ₽ | Канал: Яндекс.Директ",
    ...
    options: [
      {
        ...
        consequence: "CR вырос до 21.3%. CAC упал до 680 ₽. Оффер с конкретной цифрой дохода сработал лучше всего на аудиторию 25–35 лет, ищущую смену профессии.",
      ...
      },
      {
        ...
        consequence: "CAC вырос до 7 200 ₽. Потратили 360К дополнительно. Яндекс начал показывать рекламу нецелевой аудитории при резком росте бюджета. ROMI ушёл в минус.",
      ...
      },
      {
        ...
        consequence: "CR 9.1% — лучше, но аудитория в VK холоднее и нужно больше касаний до покупки. CAC 2 100 ₽. Не хватает регистраций для выполнения плана.",
    ...
    options: [
      {
        ...
        icon: "📊",
        detail: "Показать: LTV/CAC = 3.8x, бенчмарк B2C EdTech 2026 = 130%, наш результат = 155%. Конкретный план: 3 оптимизации воронки → 220%+ в Q2",
